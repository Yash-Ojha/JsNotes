...
function showNotes() {
    ...
    notesObj.forEach(function(element, index) {
        ...
        <div class="card-body">
            ...
            <button id="${index}"onclick="deleteNote(this.id)" class="btn btn-primary box2">Delete</button>
        </div>
    </div>`;
    });
    ...
    if (notesObj.length != 0) {
     ...
     notesElm.innerHTML = `<div class="jumbotron jumbotron-fluid bg-warning p-3 ml-5 w-75" style="
            border: 2px rgba(12, 12, 12, 0);
